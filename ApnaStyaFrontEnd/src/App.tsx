...
import { MuiDateLocalizationProvider } from "@/components/common/MuiDateLocalizationProvider";
      ...
      <DemoDataProvider>
        ...
        <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/owner/profile" element={<ProtectedRoute><Navigate to="/owner/dashboard" replace /></ProtectedRoute>} />
